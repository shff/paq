use rakastu::resolve::{normalize, resolve};
...
fn test_normalize() {
    assert_eq!(
        normalize(&Path::new("/Users/shf/Projects").join(Path::new("/Users/shf/Projects/rakastu"))),
        PathBuf::from("/Users/shf/Projects/rakastu")
    );
    assert_eq!(
        normalize(&Path::new("/Users/shf/Projects").join(Path::new("rakastu"))),
        PathBuf::from("/Users/shf/Projects/rakastu")
    );
    assert_eq!(
